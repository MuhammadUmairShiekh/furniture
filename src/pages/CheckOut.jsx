          ...
          <Row>
            ...
            <Col lg='4'>
              <div className='checkOut_Card'>
                ...
                <h6> Subtotal: <span>PKR {totalAmount}</span></h6>
                <h6>
                  <span>{totalAmount > 5000 ? "Shipping Charges" : "Free Shipping"}</span>
                ...
                <h6>
                  ...
                  <span>PKR {totalAmount * 17 / 100}</span></h6>
                <h3> Total Cost: <span>PKR  {Math.floor(totalAmount * 17 / 100 + totalAmount, totalAmount > 5000 ? "PKR" + 1100 : " ")}</span></h3>
